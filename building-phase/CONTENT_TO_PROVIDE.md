# VEFS Website - Content Collection Form
...
4. Mark completed sections with ✅
5. Leave blank if content is not yet available

**Last Updated:** December 26, 2025 (v2.0 - Added Phase 4-5 requirements)
...
[Provide main tagline - e.g., "Preserving Indigenous Trees, Empowering Communities"]
```
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3927.003101961746!2d77.8250898!3d10.180402499999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b074e6c40000001%3A0xd9348ab1ebc30b6f!2sValluvam%20Ecological%20Organic%20Farm!5e0!3m2!1sen!2sin!4v1767164074884!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
```
...
Paragraph 2: Career Progression and Professional Experience
...
Paragraph 3: Founding VEFS and Professional Contributions
...
Paragraph 4: Vision, Impact, and Recognition
...
just about production—it's about restoring our connection to nature and ensuring food that 
is truly poison-free and nourishing for our communities."
```

---

## 4. BOARD OF TRUSTEES / KEY TEAM MEMBERS
...
Current placeholder:
"To promote the conservation of indigenous tree species and sustainable farming practices while empowering local communities through environmental education and livelihood support programs."
...
? Need to check 
Year: [e.g., 2019]
Title: [e.g., Foundation Established]
Description (2-3 sentences): [What happened, significance]
...
### Donation Impact Tiers (For Donate Page)
...
Impact: [e.g., "1 tree planted and nurtured"]
```
...
Impact: [e.g., "1 community trained"]
```
...
Impact: [e.g., "1 village transformed"]
```
...
Impact: [e.g., "1 month of programs"]
```
...
## 12. PROGRAMS DATA (programs.json)
...
ID: [e.g., prog-001]
Title: [Program name]
Slug: [URL-friendly name, e.g., eco-education-schools]
Category: [education/farming/conservation/empowerment/youth/community]
Target Audience: [students/farmers/women/public/youth/seniors/professionals]
```
...
Villages Reached: [Number or N/A]
Women Empowered: [Number or N/A]
```
...
*[Repeat above format for each program - typically 5-8 programs total]*

**How many programs do you have?** _______
...
## 13. EVENTS DATA (events.json)

For each upcoming/recent event:
...
ID: [e.g., evt-001]
Title: [Event name]
Type: [workshop/seminar/field-visit/competition/webinar]
```
...
**How many upcoming events?** _______
...
## 14. TRAININGS DATA (trainings.json)
...
Sessions: [e.g., "12 sessions", "Every Saturday"]
...
Module 3: [Module name and brief description]
...
```
...
**How many training programs?** _______
...
File naming: [e.g., 2019-01-tree-plantation-1.jpg, 2019-01-tree-plantation-2.jpg]
```
...
Example:
2023-05-tree-plantation-1.jpg: "Students from XYZ School planting saplings in ABC Village, May 2023"
```

---

## 16. FUTURE PLANS (Future Plans Page)
...
Objective 2: [e.g., "Train 500+ farmers in sustainable agriculture practices"]
Objective 3: [e.g., "Plant 25,000 indigenous trees across expansion districts"]
```
...
Objective 2: [e.g., "Develop a seed bank with 100+ local tree varieties"]
Objective 3: [e.g., "Create nursery capacity for 50,000 saplings annually"]
```
...
Objective 2: [e.g., "Reach 10,000+ learners across India through online programs"]
Objective 3: [e.g., "Partner with universities for certification programs"]
```
...
Objective 2: [e.g., "Secure partnerships with 20+ schools and colleges"]
Objective 3: [e.g., "Collaborate with government on reforestation initiatives"]
```
...
Objective 2: [e.g., "Create a self-sustaining community of eco-champions"]
Objective 3: [e.g., "Document and share our model for replication across India"]
```
...
*[Repeat for 5-10 testimonials from different programs]*

**How many testimonials do you have?** _____
...
- Donations and payments (including refund policy)
- User-generated content
- Warranty disclaimers
- Limitation of liability
- Indemnification
- Governing law (India, Tamil Nadu courts)
- Changes to terms
- Severability
...
2. **Customize Specific Details:**
   ...
   **For Privacy Policy:**
   ...
   Cookie Types: [Confirm the types of cookies you'll use]
   Contact Email for Privacy Inquiries: [e.g., privacy@vefs.org]
   ```
...
Special Disclaimers: [Any additional disclaimers needed?]
```
...
- [ ] At least 3-5 programs with full details
- [ ] Bank account details for donations
- [ ] Logo files (PNG, ICO)
- [ ] Hero carousel images (4 images)
...
- [ ] Timeline milestones
- [ ] At least 3-5 upcoming events
- [ ] At least 2-3 training programs
- [ ] Google Maps embed code
- [ ] Social media URLs
...
- [ ] Future plans (5 strategic goals)
- [ ] FAQs (10-15)
...
1. **Fill out this document** with all available information
2. **Collect and organize images** in appropriate folders
3. **Review and proofread** all text content
4. **Send completed document** to the development team
5. Development team will **integrate content** into website files
6. **Review staging site** before going live
...
**Last Updated:** December 26, 2025 (Added Phase 4-5 requirements: donation impact tiers, future plans objectives, privacy/terms review notes)
